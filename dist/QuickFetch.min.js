...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports._getLastestHeaders=r,exports._cloneObject=n,exports._isValidUseId=o,exports._formatHeaders=a,exports._parseBody=s,exports._getURL=i;var e=t(require("qs"));function t(e){return e&&e.__esModule?e:{default:e}}function r(e){var t={},r=!0,n=!1,o=void 0;try{for(var a,s=e.headers.keys()[Symbol.iterator]();!(r=(a=s.next()).done);r=!0){var i=a.value;t[i]=e.headers.get(i)}}catch(d){n=!0,o=d}finally{try{r||null==s.return||s.return()}finally{if(n)throw o}}return t}function n(e){return e&&"function"==typeof e.clone?e.clone():e}function o(e){return void 0!==e&&("string"==typeof e&&e.length||"number"==typeof e)}function a(e){e.headers&&Object.keys(e.headers).forEach(function(t){var r=e.headers[t];delete e.headers[t],t=t.toLowerCase(),e.headers[t]=r,null!=r&&""!==r||delete e.headers[t]})}function s(t,r,n){delete t.body;var o=!/^(get|head)$/i.test(r),a=t.headers&&"application/json"===t.headers["content-type"];o&&(t.body=a?JSON.stringify(n):e.default.stringify(n))}function i(t,r,n){var o=r;if(!t.body){var a=e.default.stringify(n);if(a.length){var s=~o.indexOf("?")?"&":"?";o+=s+a}}return t.baseURL&&(o="".concat(t.baseURL,"/").concat(o).replace(/\/+/g,"/")),o}
