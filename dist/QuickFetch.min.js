...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports._getLastestHeaders=r,exports._cloneObject=n,exports._isValidUseId=o,exports._formatHeaders=a,exports._parseBody=s,exports._getURL=d;var e=t(require("qs"));function t(e){return e&&e.__esModule?e:{default:e}}function r(e){var t={},r=!0,n=!1,o=void 0;try{for(var a,s=e.headers.keys()[Symbol.iterator]();!(r=(a=s.next()).done);r=!0){var d=a.value;t[d]=e.headers.get(d)}}catch(i){n=!0,o=i}finally{try{r||null==s.return||s.return()}finally{if(n)throw o}}return t}function n(e){return e&&"function"==typeof e.clone?e.clone():e}function o(e){return void 0!==e&&("string"==typeof e&&e.length||"number"==typeof e)}function a(e){e.headers&&Object.keys(e.headers).forEach(function(t){var r=e.headers[t];delete e.headers[t],t=t.toLowerCase(),e.headers[t]=r,null!=r&&""!==r||delete e.headers[t]})}function s(t,r,n){delete t.body;var o=!~t.ignoreBodyMethods.indexOf(r.toLowerCase()),a=t.forceJSON||t.headers&&/^application\/(merge\-patch\+)?json;?/.test(t.headers["content-type"]);o&&(t.body=a?JSON.stringify(n):e.default.stringify(n))}function d(t,r,n){var o=r;if(!t.body){var a=e.default.stringify(n);if(a.length){var s=~o.indexOf("?")?"&":"?";o+=s+a}}return t.baseURL&&(o="".concat(t.baseURL,"/").concat(o).replace(/\/+/g,"/")),o}
},{"qs":"OFf3"}],"WYL3":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=t(require("lodash-es/findIndex")),i=require("./utils");function t(e){return e&&e.__esModule?e:{default:e}}function n(e,i){if(!(e instanceof i))throw new TypeError("Cannot call a class as a function")}function r(e,i){for(var t=0;t<i.length;t++){var n=i[t];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}function u(e,i,t){return i&&r(e.prototype,i),t&&r(e,t),e}var s=function(){function t(){n(this,t),this._midIdFlag=0,this._mids=[]}return u(t,[{key:"_getMiddlewares",value:function(e,t){var n=this._mids.filter(function(i){return i.type===e});if(!n.length)return null;var r=n,u=t.fetchId;if((0,i._isValidUseId)(u)){if(!(r=(r=r.filter(function(e){return!e.fetchId||e.fetchId===u})).filter(function(e){return!e.disabledUses[u]})).length)return null}else r=(r=n.filter(function(e){return!e.fetchId})).filter(function(e){return!e.allDisabled});return r=r.map(function(e){return e.middleware})}},{key:"_parseMiddlewares",value:function(e,t){var n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null;return e?new Promise(function(r,u){!function t(u){var s=(0,i._cloneObject)(u);if(n&&Object.keys(n).forEach(function(e){return s[e]=n[e]}),!e.length)return r(s);e.shift()(s,t)}((0,i._cloneObject)(t))}):Promise.resolve((0,i._cloneObject)(t))}},{key:"use",value:function(e,t,n){var r=this;if(e&&"string"==typeof e&&t&&"function"==typeof t){var u=this._midIdFlag++,s={id:u,type:e,middleware:t,disabledUses:{}};return(0,i._isValidUseId)(n)&&(s.fetchId=n),this._mids.push(s),{unuse:function(){return r._unuse(u)},pause:function(e){return r._pause(u,e)},resume:function(e){return r._resume(u,e)}}}}},{key:"_unuse",value:function(i){if(void 0!==i){var t=(0,e.default)(this._mids,{id:i});t<0||this._mids.splice(t,1)}}},{key:"_pause",value:function(t,n){if(void 0!==t){var r=(0,e.default)(this._mids,{id:t});if(!(r<0)){var u=this._mids[r],s=u.disabledUses;(0,i._isValidUseId)(n)&&!s[n]?s[n]=!0:u.allDisabled=!0}}}},{key:"_resume",value:function(t,n){if(void 0!==t){var r=(0,e.default)(this._mids,{id:t});if(!(r<0)){var u=this._mids[r],s=u.disabledUses;(0,i._isValidUseId)(n)&&s[n]?delete s[n]:u.allDisabled=!1}}}}]),t}(),l=s;exports.default=l;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=c(require("qs")),t=c(require("lodash-es/mergeWith")),r=c(require("lodash-es/omit")),n=c(require("lodash-es/trim")),o=c(require("lodash-es/isEmpty")),i=c(require("./MiddlewareHolder")),u=c(require("./CustomError")),a=c(require("./OptRequest")),s=require("./utils");function c(e){return e&&e.__esModule?e:{default:e}}function l(e){return(l="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function f(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function d(e,t){for(var r=0;r<t.length;r++){var n=t[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}function p(e,t,r){return t&&d(e.prototype,t),r&&d(e,r),e}function h(e,t){return!t||"object"!==l(t)&&"function"!=typeof t?y(e):t}function y(e){if(void 0===e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return e}function _(e){return(_=Object.setPrototypeOf?Object.getPrototypeOf:function(e){return e.__proto__||Object.getPrototypeOf(e)})(e)}function E(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function");e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),t&&v(e,t)}function v(e,t){return(v=Object.setPrototypeOf||function(e,t){return e.__proto__=t,e})(e,t)}var R=function(e){function r(e){var t;return f(this,r),(t=h(this,_(r).call(this,e)))._globalOption=e,t._originFetch=fetch,t}return E(r,i.default),p(r,[{key:"_parseRequestMiddlewares",value:function(e,t){var n=this._getMiddlewares(r.REQUEST,t);return this._parseMiddlewares(n,e)}},{key:"_parseResponseMiddlewares",value:function(e,t){var n=this._getMiddlewares(r.RESPONSE,t),i={method:t.method.toUpperCase()};if(!(0,o.default)(t.headers))try{i.requestHeaders=new Headers(t.headers)}catch(u){}return this._parseMiddlewares(n,e,i)}},{key:"_parseErrorMiddlewares",value:function(e,t){var n=this._getMiddlewares(r.ERROR,t);return this._parseMiddlewares(n,e)}},{key:"_doRequest",value:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"get";e=e.toUpperCase();var o=this._originFetch;return function(i){var c=this,l=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},f=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{};f=[{method:e,credentials:"include",mode:"cors",cache:"reload",headers:{Accept:"application/json","Content-Type":"application/json"},ignoreBodyMethods:["get","head"],timeout:3e4,baseURL:"",catchError:!0},this._globalOption,f].reduce(function(e,r){return e=(0,t.default)(e,r,function(e,t,r,n,o,i){if(Array.isArray(e)&&Array.isArray(t))return t})},{}),(0,s._formatHeaders)(f),(0,s._parseBody)(f,e,l);var d,p=(0,s._getURL)(f,i,l),h=new a.default((0,n.default)(p),f);return"timeout"in f&&!Number.isNaN(parseInt(f.timeout,10))&&(d=this._originFetch,o=function(e){var t=d.apply(null,[e]),n=new Promise(function(t,n){var o=new u.default(r.EXCEPTION_TIMEOUT,e);setTimeout(function(){n(o)},f.timeout)});return Promise.race([t,n])}),this._parseRequestMiddlewares(h,f).then(function(t){var r=t.init;r.headers=(0,s._getLastestHeaders)(t),(0,s._formatHeaders)(r),(0,s._parseBody)(r,e,l);var n=(0,s._getURL)(r,i,l),u=new a.default(n,r);return o(u).then(function(e){return c._parseResponseMiddlewares(e,f)}).catch(function(e){return e.request=h.clone(),c._parseErrorMiddlewares(e,f)})}).then(function(e){if(e&&e instanceof Error&&f.catchError)throw e;return e}).catch(function(e){if(e&&f.catchError)throw e})}}},{key:"get",value:function(){for(var e=arguments.length,t=new Array(e),r=0;r<e;r++)t[r]=arguments[r];return this._doRequest("get").apply(this,t)}},{key:"post",value:function(){for(var e=arguments.length,t=new Array(e),r=0;r<e;r++)t[r]=arguments[r];return this._doRequest("post").apply(this,t)}},{key:"delete",value:function(){for(var e=arguments.length,t=new Array(e),r=0;r<e;r++)t[r]=arguments[r];return this._doRequest("delete").apply(this,t)}},{key:"put",value:function(){for(var e=arguments.length,t=new Array(e),r=0;r<e;r++)t[r]=arguments[r];return this._doRequest("put").apply(this,t)}},{key:"patch",value:function(){for(var e=arguments.length,t=new Array(e),r=0;r<e;r++)t[r]=arguments[r];return this._doRequest("patch").apply(this,t)}},{key:"sequence",value:function(e){var t=[];return e.reduce(function(e,r){return e.then(function(){return r.then(function(e){return t.push(e)}).catch(function(e){return Promise.reject(e)})})},Promise.resolve()).then(function(){return t})}}]),r}();R.REQUEST="REQUESTER_TYPE_REQUEST",R.RESPONSE="REQUESTER_TYPE_RESPONSE",R.ERROR="REQUESTER_TYPE_ERROR",R.EXCEPTION_TIMEOUT="REQUESTER_ERROR_TIMEOUT";var w=R;exports.default=w;
