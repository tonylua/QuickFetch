...
},{"./_baseFindIndex.js":"c3dI","./_baseIteratee.js":"wPpc","./toInteger.js":"nczH"}],"RcLT":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=u(require("qs")),t=u(require("lodash-es/mergeWith")),r=u(require("lodash-es/omit")),n=u(require("lodash-es/keys")),i=u(require("lodash-es/map")),s=u(require("lodash-es/filter")),a=u(require("lodash-es/trim")),o=u(require("lodash-es/findIndex"));function u(e){return e&&e.__esModule?e:{default:e}}function d(e){return e&&"function"==typeof e.clone?e.clone():e}function l(e){return void 0!==e&&("string"==typeof e&&e.length||"number"==typeof e)}function c(e){Object.defineProperties(this,{_midIdFlag:{value:0,enumerable:!1,configurable:!0,writable:!0},_mids:{value:[],enumerable:!1,configurable:!0},_globalOption:{value:e,enumerable:!1,configurable:!0},_originFetch:{value:fetch,enumerable:!1,configurable:!1,writable:!1}})}c.REQUEST="REQUESTER_TYPE_REQUEST",c.RESPONSE="REQUESTER_TYPE_RESPONSE",c.ERROR="REQUESTER_TYPE_ERROR",c.EXCEPTION_TIMEOUT="REQUESTER_ERROR_TIMEOUT",c.prototype={constructor:c,_getMiddlewares:function(e,t){var r=(0,s.default)(this._mids,function(t){return t.type===e});if(!r.length)return null;var n=r;if(l(t)){if(n=(0,s.default)(n,function(e){return!e.fetchId||e.fetchId===t}),!(n=(0,s.default)(n,function(e){return!e.disabledUses[t]})).length)return null}else n=(0,s.default)(r,function(e){return!e.fetchId}),n=(0,s.default)(n,function(e){return!e.allDisabled});return n=(0,i.default)(n,function(e){return e.middleware})},_parseMiddlewares:function(e,t){return e?new Promise(function(r,n){!function t(n){var i=d(n);if(!e.length)return r(i);e.shift()(i,t)}(d(t))}):Promise.resolve(d(t))},_parseRequestMiddlewares:function(e,t){var r=this._getMiddlewares(c.REQUEST,t);return this._parseMiddlewares(r,e)},_parseResponseMiddlewares:function(e,t){var r=this._getMiddlewares(c.RESPONSE,t);return this._parseMiddlewares(r,e)},_parseErrorMiddlewares:function(e,t){var r=this._getMiddlewares(c.ERROR,t);return this._parseMiddlewares(r,e)},use:function(e,t,r){var n=this;if(e&&"string"==typeof e&&t&&"function"==typeof t){var i=this._midIdFlag++,s={id:i,type:e,middleware:t,disabledUses:{}};return l(r)&&(s.fetchId=r),this._mids.push(s),console.log("regist middleware %s %s, new array length is %s",i,l(r)?"(".concat(r,")"):"",this._mids.length),{unuse:function(){return n._unuse(i)},pause:function(e){return n._pause(i,e)},resume:function(e){return n._resume(i,e)}}}},_unuse:function(e){if(void 0!==e){var t=(0,o.default)(this._mids,{id:e});t<0||(this._mids.splice(t,1),console.log("unregist middleware ".concat(e,", new array length is ").concat(this._mids.length)))}},_pause:function(e,t){if(void 0!==e){var r=(0,o.default)(this._mids,{id:e});if(!(r<0)){var n=this._mids[r],i=n.disabledUses;l(t)&&!i[t]?i[t]=!0:n.allDisabled=!0,console.log("pause(disable) middleware ".concat(e," ").concat(l(t)?"for "+t:""),i)}}},_resume:function(e,t){if(void 0!==e){var r=(0,o.default)(this._mids,{id:e});if(!(r<0)){var n=this._mids[r],i=n.disabledUses;l(t)&&i[t]?delete i[t]:n.allDisabled=!1,console.log("resume(enable) middleware ".concat(e," ").concat(l(t)?"for "+t:""),i)}}},_doRequest:function(i){return void 0===i&&(i="get"),i=i.toUpperCase(),function(s,o,u){var d=this;void 0!==o&&o||(o={}),void 0!==u&&u||(u={}),(u=(0,t.default)({method:i,credentials:"include",mode:"cors",cache:"reload",headers:{Accept:"application/json","Content-Type":"application/json"},timeout:3e4,baseURL:"",catchError:!0},this._globalOption,u)).headers&&(0,n.default)(u.headers).forEach(function(e){var t=u.headers[e];(null==t||"string"==typeof t&&""===t)&&delete u.headers[e]}),u=(0,r.default)(u,"body");var l=!/^(get|head)$/i.test(i),f=u.headers&&"application/json"===u.headers["Content-Type"];if(l)u.body=f?JSON.stringify(o):e.default.stringify(o);else{var h=e.default.stringify(o);if(h.length){var p=~s.indexOf("?")?"&":"?";s+=p+h}}u.baseURL&&(s="".concat(u.baseURL,"/").concat(s).replace(/\/+/g,"/"),delete u.baseURL);var _,g=this._originFetch;"timeout"in u&&!Number.isNaN(parseInt(u.timeout,10))&&(_=this._originFetch,g=function(){for(var e=arguments.length,t=new Array(e),r=0;r<e;r++)t[r]=arguments[r];var n=_.apply(null,t),i=new Promise(function(e,t){setTimeout(function(){t(new Error(c.EXCEPTION_TIMEOUT))},u.timeout)});return Promise.race([n,i])});var m=new Request((0,a.default)(s),u);return this._parseRequestMiddlewares(m,u.fetchId).then(function(e){return g(e.clone()).then(function(e){return d._parseResponseMiddlewares(e,u.fetchId)}).catch(function(e){return e.request=m.clone(),d._parseErrorMiddlewares(e,u.fetchId)})}).then(function(e){if(e&&e instanceof Error&&u.catchError)throw e;return e})}},get:function(){for(var e=arguments.length,t=new Array(e),r=0;r<e;r++)t[r]=arguments[r];return this._doRequest("get").apply(this,t)},post:function(){for(var e=arguments.length,t=new Array(e),r=0;r<e;r++)t[r]=arguments[r];return this._doRequest("post").apply(this,t)},delete:function(){for(var e=arguments.length,t=new Array(e),r=0;r<e;r++)t[r]=arguments[r];return this._doRequest("delete").apply(this,t)},put:function(){for(var e=arguments.length,t=new Array(e),r=0;r<e;r++)t[r]=arguments[r];return this._doRequest("put").apply(this,t)},patch:function(){for(var e=arguments.length,t=new Array(e),r=0;r<e;r++)t[r]=arguments[r];return this._doRequest("patch").apply(this,t)},sequence:function(e){var t=[];return e.reduce(function(e,r){return e.then(function(){return r.then(function(e){return t.push(e)}).catch(function(e){return Promise.reject(e)})})},Promise.resolve()).then(function(){return t})}},Object.keys(c.prototype).filter(function(e){return"constructor"===e||/^_/.test(e)}).forEach(function(e){Object.defineProperty(c.prototype,e,{enumerable:!1,configurable:!1})});var f=c;exports.default=f;
},{"qs":"OFf3","lodash-es/mergeWith":"eRZA","lodash-es/omit":"EcSn","lodash-es/keys":"SZbr","lodash-es/map":"fJAA","lodash-es/filter":"FOEM","lodash-es/trim":"KRfZ","lodash-es/findIndex":"EmrX"}]},{},["RcLT"], null)